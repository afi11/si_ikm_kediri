...
@section('title', 'Halaman Kelola Data Kecamatan | Data Industri | Disperindag Kota Kediri')
@section('content')
    <div class="page-header">
        <h2 class="pageheader-title">Kecamatan</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <a class="btn btn-rounded btn-primary btn-sm mb-3" href="{{ url('kecamatan/tambah') }}">Tambah Data</a>
            <div class="table-responsive">
                <table id="dataMaster" class="table table-striped table-bordered first">
                    ...
                    <tbody>
                        @php $no=0; @endphp
                        @foreach ($kec as $data) @php $no++; @endphp              
                            <tr>
                                <td>{{ $no }}</td>
                                <td>{{ $data->nama_kec }}</td>
                                <td>
                                    <a href="{{ url('kecamatan/edit/'.$data->id) }}" class="btn-sm text-white btn btn-rounded btn-primary"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="kecamatan/delete/{{ $data->id }}" class="btn btn-secondary">Hapus</a>
